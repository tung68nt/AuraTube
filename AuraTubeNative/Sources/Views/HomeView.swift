                                ...
                                if vm.selectedTag == "🔔 Đang theo dõi" {
                                    Button(action: {
                                        ...
                                        VStack(spacing: 6) {
                                            ZStack {
                                                Circle()
                                                    .fill(vm.selectedChannel == nil ? Color.white : Color(white: 0.2))
                                                    .frame(width: 52, height: 52)
                                                Image(systemName: "square.grid.2x2.fill")
                                                    .font(.system(size: 20))
                                                    .foregroundColor(vm.selectedChannel == nil ? Color.black : Color.white)
                                            }
                                            .overlay(Circle().strokeBorder(Color.white.opacity(vm.selectedChannel == nil ? 0.8 : 0.2), lineWidth: 1.5))
                                            
                                            Text("Tất cả")
                                                .font(.system(size: 11.5, weight: vm.selectedChannel == nil ? .bold : .medium))
                                                .foregroundColor(vm.selectedChannel == nil ? .white : Color(white: 0.7))
                                                .frame(width: 64)
                                                .lineLimit(1)
                                        }
                                    }
                                    ...
                                    Button(action: {
                                        ...
                                        VStack(spacing: 6) {
                                            ...
                                            Text(channel.title)
                                                ...
                                                .foregroundColor(isSelected ? .cyan : Color(white: 0.8))
                                                .frame(width: 72)
                                                .lineLimit(1)
                                        }
                                    }
                                ...
                                ForEach(vm.recommendedChannels) { rec in
                                    ...
                                    HStack(spacing: 12) {
                                        ...
                                        Button(action: {
                                            ...
                                            .padding(.vertical, 6)
                                            .background(isSub ? Color.white.opacity(0.2) : Color.white)
                                            .clipShape(Capsule())
                                        }
                                        .buttonStyle(.plain)
                                    }
